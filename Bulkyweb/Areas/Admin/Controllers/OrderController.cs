...
namespace Bulkyweb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            IEnumerable<OrderHeader> OrderHeaderObj = unitOfWork.OrderHeader.GetAll(includeProperties: "ApplicationUser").ToList();

            if(User.IsInRole(SD.Role_Admin) || User.IsInRole(SD.Role_Employee))
            {
                OrderHeaderObj = unitOfWork.OrderHeader.GetAll(includeProperties: "ApplicationUser").ToList();
            }
            else
            {
                ...
                OrderHeaderObj = unitOfWork.OrderHeader.GetAll(u => u.ApplicationUserId == UserId,includeProperties: "ApplicationUser");
            }
                ...
                {
                    case "pending":
                        OrderHeaderObj = OrderHeaderObj.Where(u => u.PaymentStatus == SD.PaymentStatusDelayedPayment);
                        break;
                    case "inprocess":
                        OrderHeaderObj = OrderHeaderObj.Where(u => u.OrderStatus == SD.StatusInProcess);
                        break;
                    case "completed":
                        OrderHeaderObj = OrderHeaderObj.Where(u => u.OrderStatus == SD.StatusShipped);
                        break;
                    case "approved":
                        OrderHeaderObj = OrderHeaderObj.Where(u => u.OrderStatus == SD.StatusApproved);
                        break;
                    default:
                        break;
                }
